          ...
          <div className="flex flex-col gap-3 mb-8">
            <div className="grid grid-cols-3 gap-2 bg-gray-100 rounded-xl p-1">
              <button
                ...
                className={`py-2.5 px-3 text-xs font-semibold rounded-lg transition-all duration-300 ${userType === 'citizen'
              ...
              <button
                ...
                className={`py-2.5 px-3 text-xs font-semibold rounded-lg transition-all duration-300 ${userType === 'dept_admin'
              ...
              <button
                ...
                className={`py-2.5 px-3 text-xs font-semibold rounded-lg transition-all duration-300 ${userType === 'super_admin'
          ...
          <div className="space-y-5">
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className={`text-sm font-medium ${config.linkColor}`}>
                Forgot password?
              </button>
            </div>
